...
case 5:
printf ("Aramak istediğiniz kitabın adı giriniz : ");
scanf ("%s", ara);
...
ayni=strcmp(ara,ll[i].kitapadi);  
   ...
   printf("Kitabınız %s, %s yazarı tarafından yazılmış, okumak istiyorum kisminda bulunmus \n", ara,ll[i].yazar);    
   else  
...
ayni=strcmp(ara,l[i].kitapadi);  
   ...
   printf("Kitabınız %s, %s yazarı tarafından yazılmış, okudugun kitablari kisminda bulunmus \n", ara,l[i].yazar);  
   else  
